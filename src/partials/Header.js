...
function Header() {
  ...
  return (
    <header className={`fixed w-full z-20 md:bg-opacity-90 transition duration-300 ease-in-out ${!top && 'bg-white blur shadow-lg'}`}>
        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <nav className="flex flex-grow">
            <ul className="flex flex-grow justify-end flex-wrap items-center">
              ...
              <li>
                <Link to="/contact" className="btn-sm text-white bg-blue-600 hover:bg-blue-700 hover:text-white ml-3">
                  <span>Contact</span>
